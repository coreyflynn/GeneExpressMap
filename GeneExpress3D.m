function varargout = GeneExpress3D(varargin)
% GENEEXPRESS3D M-file for GeneExpress3D.fig
%      GENEEXPRESS3D, by itself, creates a new GENEEXPRESS3D or raises the existing
%      singleton*.
%
%      H = GENEEXPRESS3D returns the handle to a new GENEEXPRESS3D or the handle to
%      the existing singleton*.
%
%      GENEEXPRESS3D('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GENEEXPRESS3D.M with the given input arguments.
%
%      GENEEXPRESS3D('Property','Value',...) creates a new GENEEXPRESS3D or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GeneExpress3D_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GeneExpress3D_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GeneExpress3D_OpeningFcn, ...
                   'gui_OutputFcn',  @GeneExpress3D_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GeneExpress3D is made visible.
function GeneExpress3D_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for GeneExpress3D
...
if isdir(pathtest)==1
    disp('Launching python GeneExpress3D viewer')
    ...
    disp('Python GeneExpress3D viewer not available. Using MATLAB internal instead')
    h=figure;
    set(h,'Color','k');
    set(h,'Units','Pixels');
